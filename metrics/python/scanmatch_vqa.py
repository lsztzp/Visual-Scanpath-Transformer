...
ScanMatchwithDuration = ScanMatch(Xres=800, Yres=600, Xbin=16, Ybin=12, Offset=(0, 0), TempBin=100, Threshold=3.5)
ScanMatchwithoutDuration = ScanMatch(Xres=800, Yres=600, Xbin=16, Ybin=12, Offset=(0, 0), Threshold=3.5)
